...
train_csv_file = ground_dir + '/vggsound/data/valid_train_uni.csv'
test_csv_file = ground_dir + '/vggsound/data/valid_test_uni.csv'
target_fold_path = ground_dir + '/vggsound/data/frames'
...
# Extract frames from clips for efficient pre-training
